...
public interface QuestionService
{
    ...
    QuestionEntity addQuestion(String description, float points, boolean allOrNone, Long imageId) ;
    QuestionEntity updateQuestion(Long questionId, String description, float points, boolean allOrNone, Long imageId) ;
